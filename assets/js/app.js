...
// Additive visual and search upgrades; paths stay relative for GitHub Pages.
const upgradeBase = location.pathname.includes("/pages/") ? "../" : "";
const upgradeCss = document.createElement("link");
upgradeCss.rel = "stylesheet";
upgradeCss.href = upgradeBase + "assets/css/premium-upgrade.css";
document.head.appendChild(upgradeCss);
const upgradeSearch = document.createElement("script");
upgradeSearch.src = upgradeBase + "assets/js/search-upgrade.js";
document.head.appendChild(upgradeSearch);
